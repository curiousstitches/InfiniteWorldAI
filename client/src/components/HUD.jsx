...
const hud = {
  container: {
    ...
    padding: '10px 16px', background: 'linear-gradient(to bottom, rgba(0,0,0,0.7) 0%, transparent 100%)',
    pointerEvents: 'none', fontFamily: "'Crimson Pro', serif", zIndex: 10,
  },
  top: { display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' },
  location: { color: 'rgba(220,200,255,0.85)', fontSize: 14, fontStyle: 'italic', flex: 1, minWidth: 100 },
  meta: { display: 'flex', gap: 6 },
  badge: {
    color: 'rgba(180,150,255,0.6)', fontSize: 11, letterSpacing: 1,
    background: 'rgba(20,10,50,0.6)', padding: '2px 8px', borderRadius: 10,
    border: '1px solid rgba(120,60,200,0.25)', textTransform: 'uppercase',
  },
  narrative: {

...
export default function VoiceInterface() {
  ...
  const { isListening, isSpeaking, subtitles, isThinking } = useGameStore();
  ...
  return (
    <div style={styles.container}>
      {/* Big thinking indicator while the AI generates a reply */}
      {isThinking && !hideAllHud && <ThinkingIndicator />}

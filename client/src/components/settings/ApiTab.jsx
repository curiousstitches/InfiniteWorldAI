...
export default function ApiTab() {
  ...
  return (
    <div>
      {/* Re-open the first-run provider chooser */}
      <div style={css.section}>
        <div style={css.h}>AI PROVIDER · your choice</div>
        <div style={css.desc}>Change which AI powers your adventure, or paste a different free/paid key.</div>
        <button
          style={{ width: '100%', padding: '12px', borderRadius: 10, marginTop: 8, cursor: 'pointer',
            background: 'linear-gradient(135deg,#cc88ff 0%,#7a3acc 100%)', border: 'none',
            color: '#0a0218', fontSize: 14, fontWeight: 800 }}
          onClick={() => { import('../../services/providerGate').then(m => { m.resetGate(); window.location.reload(); }); }}
        >Change AI provider</button>
      </div>

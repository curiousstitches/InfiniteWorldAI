...
export const TRANSPORT = {
  ...
  NINEROUTER: '9router',  // local proxy at localhost:20128/v1, no key
...
export const LLM_PROVIDERS = [
  ...
  { id: '9router:kr/claude-sonnet-4.5',     label: 'Kiro Claude Sonnet 4.5',    tier: 'S', transport: '9router',   model: 'kr/claude-sonnet-4.5',    agents: ['companion','gm','taskgen'], keyRequired: false, free: true, notes: 'Unlimited via AWS Builder ID.' },
  { id: '9router:kr/claude-haiku-4.5',      label: 'Kiro Claude Haiku 4.5',     tier: 'A', transport: '9router',   model: 'kr/claude-haiku-4.5',     agents: ['companion','taskgen'],      keyRequired: false, free: true },
  { id: '9router:vertex/gemini-3.1-pro',    label: 'Vertex Gemini 3.1 Pro',     tier: 'S', transport: '9router',   model: 'vertex/gemini-3.1-pro-preview', agents: ['companion','gm'],     keyRequired: false, free: true, notes: '$300 GCP credit.' },
  { id: '9router:vertex/gemini-3-flash',    label: 'Vertex Gemini 3 Flash',     tier: 'A', transport: '9router',   model: 'vertex/gemini-3-flash-preview', agents: ['gm','taskgen'],       keyRequired: false, free: true },
  { id: '9router:kr/glm-5',                 label: 'Kiro GLM-5',                tier: 'B', transport: '9router',   model: 'kr/glm-5',                agents: ['gm','taskgen'],             keyRequired: false, free: true },
  { id: '9router:kr/MiniMax-M2.5',          label: 'Kiro MiniMax M2.5',         tier: 'B', transport: '9router',   model: 'kr/MiniMax-M2.5',         agents: ['taskgen'],                  keyRequired: false, free: true },
  { id: '9router:kr/deepseek-3.2',          label: 'Kiro DeepSeek 3.2',         tier: 'B', transport: '9router',   model: 'kr/deepseek-3.2',         agents: ['gm','taskgen'],             keyRequired: false, free: true },
  { id: '9router:oc/auto',                  label: 'OpenCode Free (auto)',      tier: 'C', transport: '9router',   model: 'oc/auto',                 agents: ['taskgen'],                  keyRequired: false, free: true, notes: 'Zero-auth fallback.' },
...
export const STT_PROVIDERS = [
  ...
  { id: '9router:whisper',             label: '9router Whisper',                tier: 'A', transport: '9router', model: 'whisper-1',                  keyRequired: false, free: true },
...
export const DEFAULT_CASCADE = {
  companion: ['puter:claude-opus-4-7','puter:claude-sonnet-4-6','9router:kr/claude-sonnet-4.5','puter:gpt-5.5-pro','9router:vertex/gemini-3.1-pro','puter:gemini-3.5-flash'],
  gm:        ['puter:gemini-3.5-flash','google:gemini-2.5-flash','puter:claude-sonnet-4-6','9router:vertex/gemini-3-flash','9router:kr/claude-sonnet-4.5'],
  taskgen:   ['puter:gpt-5.4-nano','groq:llama-3.3-70b-versatile','puter:gpt-5.4-mini','9router:kr/MiniMax-M2.5','cerebras:llama-3.3-70b'],
